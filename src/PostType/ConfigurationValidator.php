...
final class ConfigurationValidator {
	...
	public function validate( Configuration $configuration ): array {
		...
		} elseif ( 1 !== preg_match( '/^[a-z0-9_-]{1,20}$/', $configuration->post_type_key ) ) {
			$errors[] = __( 'The post type key must contain no more than 20 lowercase letters, numbers, underscores, or hyphens.', 'wp-architect-ai' );
