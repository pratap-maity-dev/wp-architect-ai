...
<div class="wrap">
	...
	<form method="post">
		...
		<a class="button" href="<?php echo esc_url( admin_url( 'admin.php?page=pmorix-post-type-taxonomy-rest-generator-cpt-generator' ) ); ?>"><?php echo esc_html__( 'Reset form', 'pmorix-post-type-taxonomy-rest-generator' ); ?></a>
	</form>
