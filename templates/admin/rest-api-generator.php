	...
	<form method="post">
		...
		<table class="form-table" role="presentation">
			...
			<?php foreach ( $architect_ai_code_generator_option_fields as $architect_ai_code_generator_field => $architect_ai_code_generator_label ) : ?>
				<tr><th scope="row"><?php echo esc_html( $architect_ai_code_generator_label ); ?></th><td><label><input type="checkbox" name="<?php echo esc_attr( $architect_ai_code_generator_field ); ?>" value="1" <?php checked( $configuration->{$architect_ai_code_generator_field} ); ?>> <?php echo esc_html__( 'Enabled', 'pmorix-post-type-taxonomy-rest-generator' ); ?></label></td></tr>
			<?php endforeach; ?>
